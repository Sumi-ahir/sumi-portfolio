  ...
  },
{
  ...
  const data = [
    {
      title: "Introduction",
      content: "Hi, I'm Sumita Nagotha. I started my journey with curiosity, and today I enjoy building full-stack web applications using the MERN stack. Every project teaches me something new, and that's what keeps me motivated to improve every day."
    }, {
      title: "Education",
...
" style={{ padding: "10px 25px" }}>
  ...
  border border-white/20 transition-all duration-300 hover:scale-[1.02]">
                ...
                {open === index && (
                  <div className={` text-black/80 overflow-hidden transition-all duration-500 ${open === index ? " opacity-100 p-4" : "max-h-0 opacity-0"
